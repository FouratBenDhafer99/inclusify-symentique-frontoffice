...
const PostPagetitle = (props) => {
  const {
    title,
    searchByInputFunction,
    searchByNumberInputFunction,
    searchBySelectOptions,
    searchBySelectFunction,
  } = props;
  return (
          ...
          <div className="search-form-2 ms-2 col">
            {searchByNumberInputFunction ? (
              <>
                ...
                <input
                  type="number"
                  onKeyUp={searchByNumberInputFunction}
                  className="form-control text-grey-500 mb-0 bg-greylight theme-dark-bg border-0"
                  placeholder="Search here."
                />
              </>
          ...
          <div className="search-form-2 ms-2 col">
            {searchBySelectOptions && searchBySelectFunction ? (
              <>
                <i className="ti-search font-xss"></i>
                <select
                  onChange={searchBySelectFunction}
                  className="form-control text-grey-500 mb-0 bg-greylight theme-dark-bg border-0"
                >
