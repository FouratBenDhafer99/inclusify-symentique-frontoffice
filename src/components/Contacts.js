        ...
        <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            ...
            {contactList.map((value, index) => (
                ...
                <div key={index}
                    ...
                    <figure className="avatar me-2 mb-0"><img src={`assets/images/${value.imageUrl}`} alt="avater"
                                                              className="shadow-sm rounded-circle w45"/></figure>
                    <h4 className="fw-700 text-grey-900 font-xssss mt-2">{value.name} <span
                        className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{value.friend} mutual friends</span>
                    </h4>
                    <a href="/defaultmember" className="btn-round-sm bg-white ms-auto mt-2"><span
