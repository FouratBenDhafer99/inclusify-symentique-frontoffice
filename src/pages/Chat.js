                    ...
                    <div className="middle-sidebar-left pe-0" style={{maxWidth: "100%"}}>
                        <div className="row">
                            <div className="col-lg-12 position-relative">
                                    ...
                                    <div className="chat-body p-3 ">
                                        <div className="messages-content pb-5">
                                            ...
                                            <div className="message-item">
                                                ...
                                                <div className="message-wrap">I've found some cool photos for our travel
                                                    app.
                                                </div>
                                            </div>
                                            ...
                                            <div className="message-item">
                                                ...
                                                <figure>
                                                    <img src="assets/images/product.png"
                                                         className="w-25 img-fluid rounded-3" alt="avater"/>
                                                </figure>
                                            ...
                                            <div className="message-item outgoing-message">
                                                ...
                                                <div className="message-wrap" style={{marginBottom: "90px"}}>Hey mate!
                                ...
                                <div className="chat-bottom dark-bg p-3 shadow-none theme-dark-bg"
                                     style={{width: "98%"}}>
                                    <form className="chat-form">
                                        <button className="bg-grey float-left"><i
                                            className="ti-microphone text-grey-600"></i></button>
