                                ...
                                <div className="card-body p-lg-5 p-4 w-100 border-0 ">
                                    <div className="row justify-content-center">
                                        <div className="col-lg-4 text-center">
                                            <figure className="avatar ms-auto me-auto mb-0 mt-2 w100"><img
                                                src="https://via.placeholder.com/300x300.png" alt="avater"
                                                className="shadow-sm rounded-3 w-100"/></figure>
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 mb-3">
                                                <div className="form-group">
                                                    <label className="mont-font fw-600 font-xsss mb-2">Twon /
                                                        City</label>
                                                    <input type="text" className="form-control"/>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-12 mb-3">
                                                ...
                                                <textarea className="form-control mb-0 p-3 h100 bg-greylight lh-16"
