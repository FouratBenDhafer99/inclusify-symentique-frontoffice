                                ...
                                {videoList.map((value, index) => (
                                    <div key={index} className="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                        <div className="card-body p-0 d-flex">
                                            <figure className="avatar me-3"><img src={`assets/images/${value.avater}`}
                                                                                 alt="video"
                                                                                 className="shadow-sm rounded-circle w45"/>
                                            </figure>
                                            <h4 className="fw-700 text-grey-900 font-xssss mt-1"> {value.user} <span
                                                className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500"> {value.time}</span>
                                            </h4>
                                            <a href="/defaultvideo" className="ms-auto"><i
                                        ...
                                        <div className="card-body p-0 me-lg-5">
                                            <p className="fw-500 text-grey-500 lh-26 font-xssss w-100 mb-0"> {value.des}
                                                <a href="/defaultvideo" className="fw-600 text-primary ms-2">See
                                                    more</a></p>
                                        </div>
