                                ...
                                <div className="row">
                                    <div className="col-lg-12 mb-3">
                                        <div
                                            ...
                                            <h2 className="display2-size display2-md-size fw-700 text-white mb-0 mt-0">Checkout <span
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card bg-greyblue border-0 p-4 mb-5">
                                            <p class="mb-0 mont-font font-xssss text-uppercase fw-600 text-grey-500"><i
                                                class="fa fa-exclamation-circle"></i> Have A Coupon? <a
                                                class="expand-btn text-grey-500 fw-700" href="/checkoutcoupon_info">Click
                                        ...
                                        <div class="page-title">
                                            ...
                                            <form action="#">
                                                <div class="row">
                                                    <div class="col-lg-6 mb-3">
                                                        <div class="form-gorup">
                                                            <label class="mont-font fw-600 font-xssss">First
                                                                Name</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 mb-3">
                                                        <div class="form-gorup">
                                                            <label class="mont-font fw-600 font-xssss">Twon /
                                                                City</label>
                                                            <input type="text" name="comment-name"
                                                                   class="form-control"/>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12 mb-3">
                                                        <div class="form-check text-left mb-3">
                                                            <input type="checkbox" class="form-check-input mt-2"
                                                                   id="exampleCheck1"/>
                                                            <label
                                                                class="pt--1 form-check-label fw-600 font-xsss text-grey-700">Create
                                                                an acount ?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-check text-left mb-3 mt-2">
                                                <input type="checkbox" class="form-check-input mt-2"
                                                       id="exampleCheck2"/>
                                                <label class="pt--1 form-check-label fw-600 font-xsss text-grey-700">Ship
                                            ...
                                            <div
                                                ...
                                                <table class="table order-table order-table-2 mb-0">
                                                    ...
                                                    <tr class="order-total">
                                                        <th>Order Total</th>
                                                        <td class="text-right text-grey-700 font-xsss fw-700"><span
                                                ...
                                                <form action="#" class="payment-form">
                                                    <div class="payment-group mb-4">
                                                        <div class="payment-radio">
                                                            <input type="radio" value="bank" name="payment-method"
                                                                   id="bank" checked/>
                                                            <label
                                                                class="payment-label fw-600 font-xsss text-grey-900 ms-2">Direct
                                                                Bank Transfer</label>
                                                        </div>
                                                        <div class="payment-info" data-method="bank">
                                                            <p class="font-xssss lh-24 text-grey-500 ps-4">Make your
                                                                payment directly into our bank account. Please use your
                                                                Order ID as the payment reference. Your order will not
                                                    ...
                                                    <div class="payment-group mb-4">
                                                        <div class="payment-radio">
                                                            <input type="radio" value="cheque" name="payment-method"
                                                                   id="cheque"/>
                                                            <label
                                                                class="payment-label fw-600 font-xsss text-grey-900 ms-2">
                                                                Cheque payments
                                                            </label>
                                                        </div>
                                                        <div class="payment-info cheque hide-in-default"
                                                             data-method="cheque">
                                                            <p class="font-xssss lh-24 text-grey-500 ps-4">Please send a
                                                                check to Store Name, Store Street, Store Town, Store
                                                    ...
                                                    <div class="payment-group mb-0">
                                                        ...
                                                        <div class="payment-info cash hide-in-default"
                                                             data-method="cash">
                                                            <p class="font-xssss lh-24 text-grey-500 ps-4">Pay with cash
                                                                upon delivery.</p>
                                                        </div>
                                                    </div>
                                                </form>
